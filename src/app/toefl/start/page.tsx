...
// TOEFL 응시 시작 화면(폼 선택 · 풀 모의고사 / 영역별 연습). docs/toefl-spec.md §10.
// 2026-08-19: /toefl 이 랜딩(마케팅) 페이지가 되면서 이 화면을 /toefl/start 로 옮겼다.
// 랜딩의 "풀 모의고사 시작"·"영역 연습" CTA가 전부 이 경로로 들어온다.
