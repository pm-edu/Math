...
// spec §6 conversation. 구현은 StimulusAudioTask 공용(파일 상단 주석 참고) — 아이콘/라벨만 다름.
export default function ConversationTask(props: {
  ...
  return <StimulusAudioTask {...props} icon="💬" label="Conversation" />;
}
