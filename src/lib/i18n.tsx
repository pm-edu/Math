...
const DICT = {
  ...
  study_goToMyPage: { ko: "마이페이지에서 확인하기", en: "Check on My Page" },
  trackOverview_badge: { ko: "중등 · 서비스 중", en: "Middle School · Live" },
  trackOverview_title: { ko: "중등 수학", en: "Middle School Math" },
  trackOverview_body: {
    ko: "중2·중3 내신 대비 핵심 개념과 기출 유형을 문제지 단위로 차근차근 풀어갑니다. 문제지마다 정답률 80% 이상이면 다음 문제지가 열리고, 못 미치면 틀린 문제만 다시 풉니다.",
    en: "Work through core middle-school (grade 8–9) concepts and exam-style problems worksheet by worksheet. Score 80% or higher to unlock the next worksheet — otherwise you'll retry just the ones you missed.",
  },
  trackOverview_whatYouGetTitle: { ko: "이 과정에서 하는 것", en: "What this course covers" },
  trackOverview_point1: { ko: "중2·중3 핵심 단원을 순서대로", en: "Core grade 8–9 units, in order" },
  trackOverview_point2: { ko: "문제지당 8문항, 정답률로 바로 확인", en: "8 questions per worksheet with instant scoring" },
  trackOverview_point3: { ko: "틀린 문제만 골라 다시 풀 수 있음", en: "Retry just the questions you got wrong" },
  trackOverview_startButton: { ko: "시작하기", en: "Get Started" },
  trackOverview_starting: { ko: "처리 중...", en: "Starting..." },
  trackOverview_startError: { ko: "저장하지 못했습니다. 다시 시도해주세요.", en: "Something went wrong. Please try again." },
  study_progressLabel: { ko: "{total}개 중 {done}개 완료", en: "{done} of {total} completed" },
  study_assignedSectionTitle: { ko: "배정된 문제지", en: "Assigned worksheets" },
  study_worksheetListTitle: { ko: "전체 문제지", en: "All worksheets" },
  study_statusPassed: { ko: "완료", en: "Done" },
  study_statusOpen: { ko: "열림", en: "Open" },
  study_statusLocked: { ko: "잠김", en: "Locked" },
  study_noticeBody: {
    ko: "선생님이 배정하면 마이페이지에서 확인할 수 있어요.",
    en: "Once your teacher assigns one, you can check it on My Page.",
  },
